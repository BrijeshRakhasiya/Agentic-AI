...
"""
    example_question = "What is the candidate's experience?"
    example_answer = "The candidate has 5 years of backend development experience using Node.js, PostgreSQL, and AWS."
...
"""
    ...
    print("💬 Querying Groq with one-shot prompt...")
    return query_groq(prompt)

if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage:\n  python rag_resume_groq_oneshot.py <resume.pdf> <question>")
        sys.exit(1)
